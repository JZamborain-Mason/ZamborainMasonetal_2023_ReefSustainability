...
# Description: This script Calculates total species richness based on sp-abundance distribution from serf data, then it gets individual species intrinsic growth rates from fishlife, 
...
library(dplyr)
library(reshape2)
library (poilog)#Vidar Gr?tan and Steinar Engen (2008). poilog: Poisson lognormal and bivariate Poisson lognormal distribution. R package version 0.4.
...
length(us_spdata$goodfit[us_spdata$goodfit==0])/length(us_spdata$goodfit)*100
...
fig1<-benchmark_abundance%>%
  ...
  geom_vline(xintercept =0.14,lwd=1.3,col="darkred")+geom_vline(xintercept = c(0.08, 0.31),lty=2,color="darkred")+
...
a=int_rate2 %>%
  ggplot() +
  geom_histogram(aes(exp(ln_r)),alpha=0.5) +
  geom_vline(xintercept = c(0.03*2,.07*2), color = "darkred",lty=2,lwd=1.2) +
  scale_y_continuous(expand = expand_scale()) +
  scale_x_continuous(expand = expand_scale()) +
...
b=int_rate3 %>%
  ggplot() +
  geom_histogram(aes(exp(ln_r)),alpha=0.5) +
  geom_vline(xintercept = c(0.23*2,.34*2), color = "darkred",lty=2,lwd=1.2) +
  scale_y_continuous(expand = expand_scale()) +
  scale_x_continuous(expand = expand_scale()) +
...
c=int_rate4 %>%
  ggplot() +
  geom_histogram(aes(exp(ln_r)),alpha=0.5) +
  geom_vline(xintercept = c(0.08*2,.16*2), color = "darkred",lty=2,lwd=1.2) +
  scale_y_continuous(expand = expand_scale()) +
  scale_x_continuous(expand = expand_scale()) +
...
d=int_rate5 %>%
  ggplot() +
  geom_histogram(aes(exp(ln_r)),alpha=0.5) +
  geom_vline(xintercept = c(0.08*2,.17*2), color = "darkred",lty=2,lwd=1.2) +
  scale_y_continuous(expand = expand_scale()) +
  scale_x_continuous(expand = expand_scale()) +
...
e=int_rate6 %>%
  ggplot() +
  geom_histogram(aes(exp(ln_r)),alpha=0.5) +
  geom_vline(xintercept = c(0.12*2,.18*2), color = "darkred",lty=2,lwd=1.2) +
  scale_y_continuous(expand = expand_scale()) +
  scale_x_continuous(expand = expand_scale()) +
...
f=int_rate7 %>%
  ggplot() +
  geom_histogram(aes(exp(ln_r)),alpha=0.5) +
  geom_vline(xintercept = c(0.20*2,.32*2), color = "darkred",lty=2,lwd=1.2) +
  scale_y_continuous(expand = expand_scale()) +
  scale_x_continuous(expand = expand_scale()) +
...
g=int_rate8 %>%
  ggplot() +
  geom_histogram(aes(exp(ln_r)),alpha=0.5) +
  geom_vline(xintercept = c(0.20*2,.26*2), color = "darkred",lty=2,lwd=1.2) +
  scale_y_continuous(expand = expand_scale()) +
  scale_x_continuous(expand = expand_scale()) +
...
h=int_rate9 %>%
  ggplot() +
  geom_histogram(aes(exp(ln_r)),alpha=0.5) +
  geom_vline(xintercept = c(0.08*2,.12*2), color = "darkred",lty=2,lwd=1.2) +
  scale_y_continuous(expand = expand_scale()) +
  scale_x_continuous(expand = expand_scale()) +
...
i=int_rate10 %>%
  ggplot() +
  geom_histogram(aes(exp(ln_r)),alpha=0.5) +
  geom_vline(xintercept = c(0.14*2,.21*2), color = "darkred",lty=2,lwd=1.2) +
  scale_y_continuous(expand = expand_scale()) +
  scale_x_continuous(expand = expand_scale()) +
...
j=int_rate11 %>%
  ggplot() +
  geom_histogram(aes(exp(ln_r)),alpha=0.5) +
  geom_vline(xintercept = c(0.08*2,.11*2), color = "darkred",lty=2,lwd=1.2) +
  scale_y_continuous(expand = expand_scale()) +
  scale_x_continuous(expand = expand_scale()) +
